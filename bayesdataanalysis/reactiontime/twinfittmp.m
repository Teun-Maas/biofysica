function samples = twinfittmp(t,RT,RT1,RT2,varargin)
% MCMC = TWINFIT(X,Y)
%
% Psychometric curve
%
...
parameters		= {'omega','murhotarget','sigmarhotarget',...
	'murhodistracter','sigmarhodistracter',...
	'murhostage2slow','sigmarhostage2slow',...
	'murhostage2fast','sigmarhostage2fast',...
	};
...
dataStruct = struct('t',t,'rt',rt,'nt',nt,...
	'prompt1',1./rt1,'nrt1',numel(rt1),...
	'prompt2',1./rt2,'nrt2',numel(rt2));
