function data_rcs = bf_nirs_referencechannelsubtraction(cfg, datain)
...
%  cfg.method        = string, 'QR' or 'OLS' (default = 'QR')
...
ft_revision = '$Id$'; %#ok<NASGU>
ft_nargin   = nargin; %#ok<NASGU>
ft_nargout  = nargout; %#ok<NASGU>
...
% check the options
cfg = ft_checkopt(cfg, 'method', 'char', {'QR', 'OLS'});
