...
USING MATLAB MODBUS DRIVERS
===========================

In order to use the mex-drivers for modbus, you need to install the correct
shared libraries on your system. These are found in the Libraries directory
for MacOSX, Win32 and Win64 systems.

On Win32/64 the .dll files go in C:\Windows\System32
On MacOSX the shared libs go in /uss/local/lib


Pre-built shared libraries and header files can be found in the
Thirdparty directory. You need the header files and libraries to compile a
mex file for a system.




---developer notes, in dutch---
