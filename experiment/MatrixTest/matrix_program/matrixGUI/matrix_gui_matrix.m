function varargout = matrix_gui_matrix(varargin)
% matrix_gui_matrix MATLAB code for matrix_gui_matrix.fig
%      matrix_gui_matrix, by itself, creates a new matrix_gui_matrix or raises the existing
%      singleton*.
%
%      H = matrix_gui_matrix returns the handle to a new matrix_gui_matrix or the handle to
%      the existing singleton*.
%
%      matrix_gui_matrix('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in matrix_gui_matrix.M with the given input arguments.
%
%      matrix_gui_matrix('Property','Value',...) creates a new matrix_gui_matrix or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before matrix_gui_matrix_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to matrix_gui_matrix_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help matrix_gui_matrix

% Last Modified by GUIDE v2.5 02-Sep-2021 13:08:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @matrix_gui_matrix_OpeningFcn, ...
                   'gui_OutputFcn',  @matrix_gui_matrix_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before matrix_gui_matrix is made visible.
function matrix_gui_matrix_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to matrix_gui_matrix (see VARARGIN)

% Choose default command line output for matrix_gui_matrix
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes matrix_gui_matrix wait for user response (see UIRESUME)
% uiwait(handles.User_interact_mask);


% --- Outputs from this function are returned to the command line.
function varargout = matrix_gui_matrix_OutputFcn(hObject, eventdata, handles) 
...
function User_interact_mask_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to User_interact_mask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function User_interact_mask_WindowButtonUpFcn(hObject, eventdata, handles)
% hObject    handle to User_interact_mask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
