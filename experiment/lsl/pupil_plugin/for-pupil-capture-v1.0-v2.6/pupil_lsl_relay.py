...
20180412/GW Changed outlet type to use hostname, see OUTLET_TYPE
    This enables us to use more than one pupil labs device in the network
...
OUTLET_TYPE = 'Pupil Capture @ '+socket.gethostname()
