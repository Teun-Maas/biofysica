function [expinfo,chaninfo,cLog] = pa_readcsv(logfile)
% Extract experimental parameters from a csv-file
%
% [EXPINFO,CHANINFO,LOG] = PA_READCSV(CSVFILE)
%
...
%% check INPUT %%%
logfile                 = pa_fcheckext(logfile,'.csv');
logfile                 = pa_fcheckexist(logfile,'*.csv');
if isempty(logfile)
